...
function page() {
  ...
  <>
    ...
    <div className='2xl:ml-[7.25rem] xl:ml-[5rem] lg:ml-[3rem] ml-[2.5rem] xs:ml-2 mt-[5rem] font-poppins'>
        ...
        <p className='text-[#696984] text-[1.5rem] leading-[2.7rem] tracking-[0.03rem] max-w-[97rem]'>TOTC is a platform that allows educators to create online classes whereby they can store the course materials online; manage assignments, quizzes and exams; monitor due dates; grade results and provide students with feedback all in one place.</p>
        <p className='text-[#696984] text-[1.5rem] leading-[2.7rem] tracking-[0.03rem] max-w-[99rem] mt-[1.88rem]'>TOTC is a platform that allows educators to create online classes whereby they can store the course materials online; manage assignments, quizzes and exams; monitor due dates; grade results and provide students with feedback all in one place.</p>
        <p className='text-[#696984] text-[1.5rem] leading-[2.7rem] tracking-[0.03rem] max-w-[97rem]'>TOTC is a platform that allows educators to create online classes whereby they can store the course materials online; manage assignments, quizzes and exams; monitor due dates; grade results and provide students with feedback all in one place.</p>
        <p className='text-[#696984] text-[1.5rem] leading-[2.7rem] tracking-[0.03rem] max-w-[97rem] mt-[1.88rem]'>TOTC is a platform that allows educators to create online classes whereby they can store the course materials online; manage assignments, quizzes and exams; monitor due dates; grade results and provide students with feedback all in one place.</p>

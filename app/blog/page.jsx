...
function page() {
    ...
    return (
        <>
            ...
            <Header />
            {/* main Section */}
            <div className='bg-[#9DCCFF]/[0.2] flex flex-wrap xl:flex-nowrap justify-center xl:justify-normal font-poppins'>
                <div className='2xl:ml-[7.13rem] xl:ml-[3rem] pt-[4.81rem] pb-[6.31rem]'>
                    ...
                    <h1 className='text-[#2F327D] text-[2.75rem] font-semibold md:w-[43.875rem] mt-[1.5rem] xs:w-[95%] 2xl:ml-1'>Why Swift UI Should Be on the Radar of Every Mobile Developer</h1>
                    <p className='text-[1.5rem] text-[#696984] mt-[0.88rem] font-normal leading-[2.7rem] tracking-[0.03rem] md:w-[44rem] xs:w-[90%] 2xl:ml-1'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempos Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                ...
                <div className='2xl:ml-[12rem] mt-[4.37rem]'>
            ...
            <div className='mt-[5rem] 2xl:ml-[6.87rem] font-poppins'>
                ...
                <div className='mb-[5rem] mt-[1.62rem] flex flex-wrap justify-center 2xl:justify-normal gap-10 2xl:gap-0'>
                    {blog.map((info) => (<div className='relative 2xl:mr-[4.75rem]'>
                        {info.img}

        ...
        <nav className="ml-[7.56rem] pt-[1.88rem] flex items-center justify-between ">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center  ml-[5.06rem] mr-[8.375rem] h-auto">
              <button className="text-[#5B5B5B] text-[1.375rem] font-medium tracking-[0.0275rem] w-40 h-[3.75rem] rounded-[5rem] shadow-[0px 20px 24px 0px rgba(0, 0, 0, 0.03)] bg-[#fff]">Login</button>

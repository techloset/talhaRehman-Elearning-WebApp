        ...
        <div className='mt-[4.25rem]'>
          ...
          <div className='flex justify-center mt-[3.23rem] pb-[3.25rem] font-poppins'>
            <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
              <a href="#" class="relative inline-flex items-center  px-3 py-3 bg-[rgba(73,187,189,0.20)] text-[#49BBBD] xl:text-[40px] font-black hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                <span class="sr-only">Previous</span>
                <svg class="xl:text-[40px] text-[#49BBBD] h-8 w-7" viewBox="0 0 20 20" fill="#49BBBD" aria-hidden="true">
                  <path fill-rule="evenodd" d="M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z" clip-rule="evenodd" />
                </svg>
              </a>

              <a href="#" aria-current="page" class="relative z-10 inline-flex items-center px-4 py-2 text-3xl   focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">1</a>
              <a href="#" class="relative inline-flex items-center px-4 py-2 text-3xl  text-gray-900 focus:z-20 focus:outline-offset-0">2</a>
              <a href="#" class="relative hidden items-center px-4 py-2 text-3xl  text-white bg-[#49BBBD]  focus:z-20 focus:outline-offset-0 md:inline-flex">3</a>
              <a href="#" class="relative hidden items-center px-4 py-2 text-3xl text-gray-900  focus:z-20 focus:outline-offset-0 md:inline-flex">4</a>
              <a href="#" class="relative hidden items-center px-4 py-2 text-3xl  text-gray-900  focus:z-20 focus:outline-offset-0 md:inline-flex">5</a>
            
              <a href="#" class="relative inline-flex items-center px-3 py-3 bg-[rgba(73,187,189,0.20)] text-[#49BBBD] font-black  focus:z-20 focus:outline-offset-0">

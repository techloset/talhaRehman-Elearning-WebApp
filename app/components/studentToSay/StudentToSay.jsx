...
function StudentToSay() {
  return (
    <>
    <div className='bg-[#9DCCFF]/[0.2] lg:pl-[8rem] pl-[3rem] xs:pl-[1rem] pb-[15rem] mt-28 '>
        <h2 className='pt-[5rem] text-[2.25rem] text-[#2D3436] xs:w-[95%]'>What our students have to say</h2>

  ...
  return (
   <>
    <div className='mt-[19rem] overflow-x-hidden overflow-y-hidden font-poppins'>
        ...
        <div className='2xl:pl-[13.19rem] xs:mx-3 xl:ml-20 2xl:ml-0 mt-[10rem] 2xl:mr-[12.6rem] grid xl:grid-cols-2 grid-cols-1  justify-center overflow-x-hidden overflow-y-hidden'>
            <div className='relative lg:left-[20%] mx-auto xl:mx-0 xl:left-0'>
                ...
                <Image src={ellipse2} alt="green circle" className='absolute top-[59%] left-[81%] -z-10' />

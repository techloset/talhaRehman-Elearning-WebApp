    ...
    <div className='mt-[19rem] overflow-hidden font-poppins'>
        ...
        <div className='2xl:pl-[13.19rem] 2xl:pb-[4rem] xs:mx-3 xl:ml-20 2xl:ml-0 pt-[10rem]  2xl:pr-[12.6rem] grid xl:grid-cols-2 grid-cols-1  justify-center lg:justify-normal  font-poppins'>
            <div className='relative  mx-auto xl:mx-0 xl:left-0'>
                ...
                <p className='mt-[1.88rem] xl:w-[45rem] w-[87%] xs:w-[85%] text-[#696984] text-[1.5rem] leading-[2.7rem] tracking-[0.03rem]'>TOTC’s school management software helps traditional and online schools manage scheduling, attendance, payments and virtual classrooms all in one secure cloud-based system.</p>

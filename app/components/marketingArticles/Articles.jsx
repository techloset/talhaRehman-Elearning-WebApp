...
function Articles() {
    ...
    return (
        <>
            <div className='xl:mx-0 font-poppins mx-3'> 
                ...
                <div className='2xl:ml-[7.9rem] mt-[3.13rem] pb-[10.69rem]  flex flex-wrap justify-center 2xl:justify-normal gap-[3.12rem]'>

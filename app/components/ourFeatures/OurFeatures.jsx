                    ...
                    <div className='mt-[15rem] xs:mt-[2rem]'>
                        <div className='grid grid-cols-12 '>
                            <div className='xl:col-span-6 col-span-12 mx-auto xl:mx-0'>
                                <h2 className='text-[2.5rem] font-semibold leading-[4rem] text-[#2F327D] sm:ml-16 w-[24rem] xs:w-[95%] mt-28'> <span className='text-[#00CBB8]'>Tools</span> For Teachers And Learners</h2>
                                <p className='text-[#696984] text-[1.375rem] leading-[2.475rem] tracking-[0.0275rem] w-[36rem] xs:w-[90%] mt-[1.25rem] sm:ml-16'>Class has a dynamic set of teaching tools built to be deployed and used during class.
                        ...
                        <div className='grid grid-cols-12 mt-[12.75rem] '>
                            ...
                            <div className='xl:col-span-6 col-span-12  mx-auto xl:mx-0 mt-10 xl:mt-0 2xl:mr-[17rem]'>
                                <h2 className='text-[2.5rem] font-semibold leading-[4rem] text-[#2F327D] sm:ml-7 w-[24rem] mt-40 xs:mt-16'>Assessments,  <span className='text-[#00CBB8]'>Quizzes</span>, Tests </h2>
                                <p className='text-[#696984] text-[1.375rem] leading-[2.475rem] tracking-[0.0275rem] w-[36rem] xs:w-[90%] mt-[1.25rem] sm:ml-7'>Easily launch live assignments, quizzes, and tests.
                                    Student results are automatically entered in the online gradebook.</p>
                            </div>

                        </div>
                        <div className='grid grid-cols-12 xl:mt-[10rem] xl:gap-[9rem] '>
                        ...
                        <div className='grid grid-cols-12 mt-[9rem] '>
                            ...
                            <div className='xl:col-span-6 col-span-12 mx-auto xl:mx-0'>
                                <h2 className='text-[2.5rem] font-semibold leading-[4rem] text-[#2F327D] sm:ml-24 2xl:ml-14 w-[24rem] mt-40 xs:mt-16'> One-on-One <span className='text-[#00CBB8]'>Discussions</span></h2>
                                <p className='text-[#696984] text-[1.375rem] leading-[2.475rem] tracking-[0.0275rem] 2xl:ml-14 w-[34rem] mt-[1.25rem] sm:ml-24 xs:w-[90%]'>Teachers and teacher assistants can talk with students privately without leaving the Zoom environment.</p>
                            </div>

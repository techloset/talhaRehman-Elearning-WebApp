    ...
    <>
        <div className=' bg-[#252641] flex flex-col items-center '>
            ...
            <div className='mt-[6.44rem]'>
                ...
                <form action="" className='mt-[1.25rem]'>
                    <input type="email" className='w-[25rem] h-[3.75rem] rounded-[5rem] border-[#83839A] border bg-transparent text-[1.25rem]  tracking-[0.05rem] py-[0.94rem] px-[1.87rem] ' placeholder='Your Email' />
                    <button className='text-[#fff] text-[1.375rem] font-medium bg-[#49BBBD] rounded-[3.75rem] w-[11.1875rem] h-[3.75rem] ml-[1.25rem]'>Subscribe</button>
                </form>
            </div>

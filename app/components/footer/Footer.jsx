    ...
    <>
        <div className=' bg-[#252641] flex flex-col items-center '>
            ...
            <div className='mt-[6.44rem] '>
                ...
                <form action="" className='mt-[1.25rem] xs:flex xs:flex-col xs:items-center xs:flex-wrap xs:justify-center'>
                    <input type="email" className='w-[25rem] xs:w-[18rem] h-[3.75rem] rounded-[5rem] border-[#83839A] border bg-transparent text-[1.25rem]  tracking-[0.05rem] py-[0.94rem] px-[1.87rem] ' placeholder='Your Email' />
            ...
            <div className='mt-[6rem]'>
                ...
                <p className='text-[#B2B3CF] text-[1.375rem] tracking-[0.055rem] mt-[1.25rem] mb-[2.5rem] text-center xs:w-[99%]'>© 2021 Class Technologies Inc. </p>
            </div>
        </div>    
    </>
  )

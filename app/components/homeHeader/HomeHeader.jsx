...
function HomeHeader() {
  ...
  return (
   ...
   <header className="header-bg  overflow-x-hidden">
        ...
        <div className="justify-between px-5  mx-auto xs:mt-[0px] xl:max-w-7xl xl:items-center xl:flex xl:px-8">
          <div>
        ...
        <main className="xl:pt-[15.06rem] xs:pt-10 pt-[7rem] 2xl:ml-[8.75rem] lg:ml-20 grid xl:grid-cols-2 grid-cols-1 justify-center pb-[23.69rem] ">

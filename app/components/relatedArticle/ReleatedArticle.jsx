...
function ReleatedArticle() {
    return (
        <>
            <div className='bg-[#9DCCFF]/[0.2]  xl:px-5 2xl:px-0'>
                ...
                <div className='mt-[2.56rem] 2xl:ml-[7.25rem] xl:gap-[6.19rem] lg:gap-9 flex flex-wrap lg:flex-nowrap xs:justify-center sm:justify-center 2xl:justify-normal xs:gap-10 '>

...
function page() {
  return (
   <>
   <div className='mt-[2.38rem] xs:mt-[133px] xs:pb-[6.44rem] xs:ml-[1.62rem] xs:mr-[1.12rem] lg:ml-[2.56rem] flex flex-wrap xl:flex-nowrap sm:justify-center xl:justify-normal gap-[6.94rem] xs:justify-center lg:mr-[6.94rem] 2xl:justify-center'>

...
function page() {
  return (
   <>
   <div className='mt-[2.38rem] xs:mt-[6.44rem] xs:pb-[6.44rem] xs:ml-[1.62rem] xs:mr-[1.12rem] lg:ml-[2.56rem] flex flex-wrap xl:flex-nowrap sm:justify-center xl:justify-normal gap-[6.94rem] xs:justify-center lg:mr-[6.94rem] 2xl:justify-center'>
        ...
        <div className='xl:pr-[6.rem] lg:pr-[3rem] sm:order-1 '>
            ...
            <p className='mt-[3.25rem] text-[#5B5B5B] text-[1rem] w-[28.375rem] xs:w-[20.68rem] sm:pl-6 xs:pl-[1.62rem]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>

...
function page() {
  return (
    <>
     <div className='mt-[2.38rem] xs:mt-[6.44rem] xs:ml-[1.62rem] xs:mr-[1.12rem] lg:ml-[2.56rem] flex flex-wrap xl:flex-nowrap sm:justify-center xl:justify-normal gap-[7.3rem] xs:justify-center  lg:mr-[6rem] 2xl:justify-center'>
        ...
        <div className='xl:pr-[6.rem] lg:pr-[3rem] sm:order-1 '>
            ...
            <form action="" className='mt-[2.63rem] pl-6 flex flex-col'>
                ...
                <Image src={passHide}  alt='Passworrd hide' className='relative left-[90%] -top-9' />
                <button className='text-[#FFFFFF] text-base w-[14.5rem]  h-[3.0625rem] mt-[3.8rem] ml-[46%] rounded-[2.5rem] bg-[#49BBBD]'>Register</button>
            </form>
